...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto  px-4 py-8">
      ...
      <p>While using our Site, we may request certain personally identifiable information from you, which can be used to contact or identify you. This information may include, but is not limited to, your name ("Personal Information").</p>
      ...
      <p>We may use your Personal Information to contact you with newsletters, marketing or promotional materials and other information along with using it to enhance the end user experience.</p>
