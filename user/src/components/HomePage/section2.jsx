      ...
      <div className="max-w-6xl mx-auto">
        <div className="">
          <div className="md:col-span-2">
            ...
            <p className="mb-[50px] font-light text-xl"><b className='text-purple-800  text-2xl'>Building It</b>, where your vision becomes reality. Whether you're dreaming of a cozy residence or a sprawling estate, our team of experts is here to guide you every step of the way. Our commitment to quality and innovation ensures that your project is in the best hands.
