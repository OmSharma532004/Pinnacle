...
const AnimatedCard = ({ item, isSelected, onAddOrRemove }) => {
    ...
    return (
        <animated.div style={props}     onClick={() => onAddOrRemove(item)} className="p-4 border rounded-lg m-2 flex flex-col bg-purple-300 text-black  hover:bg-gray-200 font-bold items-center justify-between w-60">
