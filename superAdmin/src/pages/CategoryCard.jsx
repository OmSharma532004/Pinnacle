...
const CategoryCard = ({ category, onClick, selectedItem, price }) => {
  ...
  return (
    <div className={`transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 cursor-pointer shadow-lg rounded-xl p-6 bg-yellow-400 text-black`}
         onClick={onClick}>
